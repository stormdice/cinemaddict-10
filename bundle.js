...
class Api {
  ...
  createComment(movieId, comment) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_comment__WEBPACK_IMPORTED_MODULE_1__["default"].parseComment);
  }
...
class Provider {
  ...
  getMovies() {
    ...
    return Promise.resolve(_models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies(storeMovies));
  }
  ...
  updateMovie(id, movie) {
    ...
    const fakeUpdatedMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie(Object.assign({}, movie.toRAW(), {id}));
...
/***/ "./src/components/comment-form.js":
/*!****************************************!*\
  !*** ./src/components/comment-form.js ***!
  \****************************************/
/*! exports provided: default */
...
const createNewCommentMarkup = () => {
  const emotions = createEmotionsMarkup(_const__WEBPACK_IMPORTED_MODULE_1__["EMOTIONS"]);
...
class CommentForm extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/*!************************************!*\
  !*** ./src/components/comments.js ***!
  \************************************/
/*! exports provided: default, DEFAULT_DELETE_BUTTON_TEXT */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Comments; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_DELETE_BUTTON_TEXT", function() { return DEFAULT_DELETE_BUTTON_TEXT; });
/* harmony import */ var _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component */ "./src/components/abstract-smart-component.js");
...
const createCommentTemplate = (comment, isPressed, modifiedDeleteButtonText) => {
  ...
  const commentDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["commentFormatDate"])(date);
...
class Comments extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
const createFilmDetailsTemplate = (film) => {
  ...
  const release = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["filmDetailsFormatReleaseDate"])(releaseDate);
  const filmRuntime = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatRuntime"])(runtime);
...
class FilmDetails extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(film) {
    super();
  ...
  setWatchlistInputChangeHandler(handler) {
    this.getElement().querySelector(`#watchlist`)
      .addEventListener(`change`, lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(handler, _const__WEBPACK_IMPORTED_MODULE_1__["DEBOUNCE_TIMEOUT"]));
  }
...
/***/ "./src/components/film-list-container.js":
/*!***********************************************!*\
  !*** ./src/components/film-list-container.js ***!
  \***********************************************/
/*! exports provided: default */
...
class FilmsListContainer extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/film-section.js":
/*!****************************************!*\
  !*** ./src/components/film-section.js ***!
  \****************************************/
/*! exports provided: default */
...
class FilmsSection extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createFilmTemplate = (film) => {
  ...
  const release = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["filmCardFormatReleaseDate"])(releaseDate);
...
class Film extends _abstract_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(film) {
    super();
  ...
  setWatchlistClickHandler(handler) {
    this.getElement().querySelector(`.film-card__controls-item--add-to-watchlist`)
      .addEventListener(`click`, lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(handler, _const__WEBPACK_IMPORTED_MODULE_1__["DEBOUNCE_TIMEOUT"]));
  }
...
/***/ "./src/components/films-loading.js":
/*!*****************************************!*\
  !*** ./src/components/films-loading.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmsListLoading; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class FilmsListLoading extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createFilterMarkup = (filter) => {
  ...
  const createFiltersCountMarkup = () => {
    if (name === _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL) {
      return ``;
    }
...
const getUserRank = (watchedMovies) => {
  if (watchedMovies >= _const__WEBPACK_IMPORTED_MODULE_1__["userRanks"].novice.min && watchedMovies <= _const__WEBPACK_IMPORTED_MODULE_1__["userRanks"].novice.max) {
    return `Novice`;
  }

  if (watchedMovies >= _const__WEBPACK_IMPORTED_MODULE_1__["userRanks"].fan.min && watchedMovies <= _const__WEBPACK_IMPORTED_MODULE_1__["userRanks"].fan.max) {
    return `Fan`;
  }

  if (watchedMovies >= _const__WEBPACK_IMPORTED_MODULE_1__["userRanks"].movieBuff.min) {
    return `Movie buff`;
  }
...
class ShowMoreButton extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSortTemplate = () => {
  return (
    `<ul class="sort">
      <li><a href="#" class="sort__button sort__button--active" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">Sort by default</a></li>
      <li><a href="#" class="sort__button" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}">Sort by date</a></li>
      <li><a href="#" class="sort__button" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING}">Sort by rating</a></li>
    </ul>`
  );
};
...
class Sort extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._currentSortType = _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT;
  }
...
/* harmony import */ var _profile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./profile */ "./src/components/profile.js");
...
chart_js__WEBPACK_IMPORTED_MODULE_1___default.a.helpers.merge(chart_js__WEBPACK_IMPORTED_MODULE_1___default.a.defaults, {
  scale: {
    ticks: {
      fontColor: `#ffffff`,
      padding: 110,
...
const createUserRankTemplate = (count) => {
  return (
    `<p class="statistic__rank">
      ...
      <span class="statistic__rank-label">${Object(_profile__WEBPACK_IMPORTED_MODULE_3__["getUserRank"])(count)}</span>
    </p>`
  );
};
...
const createStatisticsTemplate = ({films}) => {
  ...
  const DURATION = {
    HOURS: Math.trunc(totalDurationCount / _utils_common__WEBPACK_IMPORTED_MODULE_4__["SECONDS_IN_A_MINUTE"]),
    MINUTES: totalDurationCount % _utils_common__WEBPACK_IMPORTED_MODULE_4__["SECONDS_IN_A_MINUTE"],
  };
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EMOTIONS, DEBOUNCE_TIMEOUT, SortType, userRanks, FilterType, StatisticsType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticsType", function() { return StatisticsType; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentController; });
/* harmony import */ var _components_comments__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/comments */ "./src/components/comments.js");
/* harmony import */ var _components_comment_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/comment-form */ "./src/components/comment-form.js");
...
const parseFormData = (formData) => {
  return new _models_comment__WEBPACK_IMPORTED_MODULE_2__["default"]({
    'comment': he__WEBPACK_IMPORTED_MODULE_4___default.a.encode(formData.get(`comment`)),
...
class CommentController {
  ...
  render(comments) {
    ...
    this._comments = comments;
    this._commentsComponent = new _components_comments__WEBPACK_IMPORTED_MODULE_0__["default"](this._comments);
    ...
    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._commentsComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(container, this._commentsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
    }
  }
  ...
  renderCommentsForm() {
    ...
    this._commentFormComponent = new _components_comment_form__WEBPACK_IMPORTED_MODULE_1__["default"]();
    ...
    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._commentFormComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(container, this._commentFormComponent, _utils_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
    }
  }
  ...
  _setCommentDelete(commentId) {
    this._api.deleteComment(commentId)
      ...
      .catch(() => {
        this._commentsComponent.setDeleteButtonText(commentId, _components_comments__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_DELETE_BUTTON_TEXT"]);
        if (this._shake !== null) {
          this._shake();
...
class MenuController {
  ...
  render() {
    ...
    const filters = Object.values(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filter__WEBPACK_IMPORTED_MODULE_3__["getFilmsByFilter"])(allFilms, filterType).length,
    ...
    this._filterComponent = new _components_menu__WEBPACK_IMPORTED_MODULE_0__["default"](filters);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filterComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filterComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
...
/* harmony import */ var _components_film__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/film */ "./src/components/film.js");
/* harmony import */ var _components_film_details__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/film-details */ "./src/components/film-details.js");
/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/movie */ "./src/models/movie.js");
/* harmony import */ var _comments_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./comments-controller */ "./src/controllers/comments-controller.js");
...
class MovieController {
  ...
  render(film) {
    ...
    this._filmComponent = new _components_film__WEBPACK_IMPORTED_MODULE_0__["default"](film);
    this._filmDetailsComponent = new _components_film_details__WEBPACK_IMPORTED_MODULE_1__["default"](film);

    this._commentsContainer = this._filmDetailsComponent.getCommentsContainer();

    this._commentsController = new _comments_controller__WEBPACK_IMPORTED_MODULE_3__["default"](this._commentsContainer, film, this._api);
    ...
    this._filmDetailsComponent.setUserRatingInputChangeHandler((score) => {
      const updatedFilm = _models_movie__WEBPACK_IMPORTED_MODULE_2__["default"].clone(film);
    ...
    if (oldFilmComponent && oldFilmDetailsComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._filmComponent, oldFilmComponent);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._filmDetailsComponent, oldFilmDetailsComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(this._container, this._filmComponent, _utils_render__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
    }
  ...
  _openFilmDetails(film) {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(document.body, this._filmDetailsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
...
/* harmony import */ var _movie_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./movie-controller */ "./src/controllers/movie-controller.js");
...
/* harmony import */ var _components_film_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/film-list */ "./src/components/film-list.js");
/* harmony import */ var _components_film_list_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/film-list-container */ "./src/components/film-list-container.js");
/* harmony import */ var _components_no_films__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/no-films */ "./src/components/no-films.js");
...
const renderFilms = (filmListElement, films, onDataChange, onCommentsDataChange, onViewChange, api) => {
  return films.map((film) => {
    const movieController = new _movie_controller__WEBPACK_IMPORTED_MODULE_0__["default"](filmListElement, onDataChange, onCommentsDataChange, onViewChange, api);
...
const getSortedFilms = (films, sortType, from, to) => {
  ...
  switch (sortType) {
    case _const__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT:
      sortedFilms = showingFilms;
      break;
    case _const__WEBPACK_IMPORTED_MODULE_6__["SortType"].DATE:
      sortedFilms = showingFilms.sort((a, b) => new Date(b.releaseDate) - new Date(a.releaseDate));
      break;
    case _const__WEBPACK_IMPORTED_MODULE_6__["SortType"].RATING:
...
class PageController {
  constructor(container, moviesModel, api) {
    ...
    this._sortComponent = new _components_sort__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._noFilmsComponent = new _components_no_films__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._filmListComponent = new _components_film_list__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._filmListContainerComponent = new _components_film_list_container__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._showMoreButtonComponent = new _components_show_more_button__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._topRatedFilmList = new _components_film_list__WEBPACK_IMPORTED_MODULE_2__["default"](`Top rated`);
    this._mostCommentedFilmList = new _components_film_list__WEBPACK_IMPORTED_MODULE_2__["default"](`Most commented`);
  ...
  render() {
    ...
    if (!films.length) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(container, this._noFilmsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);

      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(container, this._filmListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(this._filmListComponent.getElement(), this._filmListContainerComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
  ...
  _renderShowMoreButton() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._showMoreButtonComponent);
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(filmListElement, this._showMoreButtonComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
  ...
  _renderTopFilms(films, filmsList) {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(filmsList);

    if (films.length) {
      const filmListContainerComponent = new _components_film_list_container__WEBPACK_IMPORTED_MODULE_3__["default"]();
      const container = this._container.getElement();

      Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(container, filmsList, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(filmsList.getElement(), filmListContainerComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
...
class ProfileController {
  ...
  render() {
    ...
    this._profileComponent = new _components_profile__WEBPACK_IMPORTED_MODULE_0__["default"](watchedMoviesCount);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._profileComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(container, this._profileComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    }
  }
...
/* harmony import */ var _controllers_profile_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/profile-controller */ "./src/controllers/profile-controller.js");
/* harmony import */ var _controllers_menu_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/menu-controller */ "./src/controllers/menu-controller.js");
/* harmony import */ var _controllers_page_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/page-controller */ "./src/controllers/page-controller.js");
/* harmony import */ var _components_film_section__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/film-section */ "./src/components/film-section.js");
/* harmony import */ var _components_films_loading__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/films-loading */ "./src/components/films-loading.js");
/* harmony import */ var _components_statistics__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/statistics */ "./src/components/statistics.js");
/* harmony import */ var _models_movies__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./models/movies */ "./src/models/movies.js");
...
const api = new _api_index__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_1__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_2__["default"](api, store);
const moviesModel = new _models_movies__WEBPACK_IMPORTED_MODULE_9__["default"]();

const siteHeaderElement = document.querySelector(`.header`);
const siteMainElement = document.querySelector(`.main`);
const footerFilmsCount = document.querySelector(`.footer__statistics p`);

const profileController = new _controllers_profile_controller__WEBPACK_IMPORTED_MODULE_3__["default"](siteHeaderElement, moviesModel);
const menuController = new _controllers_menu_controller__WEBPACK_IMPORTED_MODULE_4__["default"](siteMainElement, moviesModel);
const filmsSectionComponent = new _components_film_section__WEBPACK_IMPORTED_MODULE_6__["default"]();
const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_8__["default"](moviesModel);
const filmsListLoadingComponent = new _components_films_loading__WEBPACK_IMPORTED_MODULE_7__["default"](`Loading...`);

menuController.render();
profileController.render();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, filmsSectionComponent, _utils_render__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(
    filmsSectionComponent.getElement(),
    filmsListLoadingComponent,
    _utils_render__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND
);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
statisticsComponent.hide();

const pageController = new _controllers_page_controller__WEBPACK_IMPORTED_MODULE_5__["default"](
...
/* harmony import */ var _utils_statistics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/statistics */ "./src/utils/statistics.js");
...
class Movies {
  constructor() {
    this._films = [];
    this._activeFilterType = _const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].ALL;
    this._statisticsType = _const__WEBPACK_IMPORTED_MODULE_2__["StatisticsType"].ALL;
  ...
  get films() {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_0__["getFilmsByFilter"])(this._films, this._activeFilterType);
  }
  ...
  get statisticsFilms() {
    return Object(_utils_statistics__WEBPACK_IMPORTED_MODULE_1__["getFilmsByStatistics"])(this.watchedFilms, this._statisticsType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: SECONDS_IN_A_MINUTE, formatRuntime, filmCardFormatReleaseDate, filmDetailsFormatReleaseDate, commentFormatDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SECONDS_IN_A_MINUTE", function() { return SECONDS_IN_A_MINUTE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatRuntime", function() { return formatRuntime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filmCardFormatReleaseDate", function() { return filmCardFormatReleaseDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filmDetailsFormatReleaseDate", function() { return filmDetailsFormatReleaseDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "commentFormatDate", function() { return commentFormatDate; });
...
const filmCardFormatReleaseDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(date).format(`YYYY`);
};

const filmDetailsFormatReleaseDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(date).format(`DD MMMM YYYY`);
};
...
const commentFormatDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc().to(date);
};
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getAllFilms, getWatchlistFIlms, getHistoryFilms, getFavoritesFilms, getFilmsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHistoryFilms", function() { return getHistoryFilms; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFavoritesFilms", function() { return getFavoritesFilms; });
...
const getFilmsByFilter = (films, filterType) => {
  switch (filterType) {
    ...
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST:
      return getWatchlistFIlms(films);
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY:
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: getFilmsByStatistics */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilmsByStatistics", function() { return getFilmsByStatistics; });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const */ "./src/const.js");
...
const getTodayWatchedFilms = (films) => {
  return films
    .filter((film) => moment__WEBPACK_IMPORTED_MODULE_1___default()(film.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_1___default()().startOf(`day`), moment__WEBPACK_IMPORTED_MODULE_1___default()().endOf(`day`)));
};

const getWeekWatchedFilms = (films) => {
  return films
    .filter((film) => moment__WEBPACK_IMPORTED_MODULE_1___default()(film.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_1___default()().startOf(`isoWeek`), moment__WEBPACK_IMPORTED_MODULE_1___default()().endOf(`isoWeek`)));
};

const getMonthWatchedFilms = (films) => {
  return films
    .filter((film) => moment__WEBPACK_IMPORTED_MODULE_1___default()(film.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_1___default()().startOf(`month`), moment__WEBPACK_IMPORTED_MODULE_1___default()().endOf(`month`)));
};

const getYearWatchedFilms = (films) => {
  return films
    .filter((film) => moment__WEBPACK_IMPORTED_MODULE_1___default()(film.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_1___default()().startOf(`year`), moment__WEBPACK_IMPORTED_MODULE_1___default()().endOf(`year`)));
};

const getFilmsByStatistics = (films, filterType) => {
  switch (filterType) {
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].ALL:
      return getAllTimeFilms(films);
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].TODAY:
      return getTodayWatchedFilms(films);
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].WEEK:
      return getWeekWatchedFilms(films);
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].MONTH:
      return getMonthWatchedFilms(films);
    case _const__WEBPACK_IMPORTED_MODULE_0__["StatisticsType"].YEAR:
