...
/**
 * Создаёт и возвращает разметку кнопки 'Загрузить больше'
 * @return {string}
 */
...
/**
 * Создаёт и возвращает разметку дополнительного блока с фильмами
 * @return {string}
 */
...
render(filmList, createLoadMoreButtonTemplate());
