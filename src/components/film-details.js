...
import {formatFilmDetailsReleaseDate, formatComments} from '../utils/common';

const getFilmGenresTemplate = (genres) => {
...
const getUserRatingTemplate = (poster, title) => {
  return (/* html */
...
const getCommentsTemplate = (date) => {
  const commentDate = formatComments(date);
...
const getFilmDetailsTemplate = (film) => {
  ...
  const releaseDate = formatFilmDetailsReleaseDate(date);
  ...
  return (/* html */
    `<section class="film-details">
      <form class="film-details__inner" action="" method="get">
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">${getFilmGenresTemplate(genres)}</td>
                </tr>
              </table>
        ...
        ${isWatched ? getUserRatingTemplate(poster, title) : ``}

        <div class="form-details__bottom-container">
        <section class="film-details__comments-wrap">
          <h3 class="film-details__comments-title">Comments <span class="film-details__comments-count">4</span></h3>

          <ul class="film-details__comments-list">${getCommentsTemplate(new Date())}</ul>
          ...
          <div class="film-details__new-comment">
            ...
            <div class="film-details__emoji-list">${getEmotionsTemplate()}</div>
          </div>
        </section>
      </div>
